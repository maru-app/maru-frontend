...
export const getAllStreak = async (year: number): Promise<ApiResponse<GetAllStreakQueryReturn>> => {
...
export const getStreak = async (date: string): Promise<ApiResponse<GetStreakQueryReturn>> => {
